...
public class DefineService {
    ...
    public static final String BYTEHONOR_PROXY_SERVER = "bytehonor-proxy-server";

    public static final String COMMON_BASIC_SERVER = "common-basic-server";
    ...
    public static final String MEDIA_PROXY_SERVER = "media-proxy-server";

    public static final String PAYMENT_CENTER_SERVER = "payment-center-server";

    public static final String STOCK_MONITOR_SERVER = "stock-monitor-server";
